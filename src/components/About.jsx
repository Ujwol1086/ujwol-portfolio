...
const About = ({ isDarkMode }) => {
  ...
  const skills = [
    ...
    {
      title: "Design & Tools",
      desc: "Figma, Adobe Suite, Git, Docker",
      icon: Palette,
      progress: 75,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          >
            ...
            innovative solutions and turning complex problems into elegant,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I'm a detail-oriented developer who thrives on creating seamless
                user experiences and robust backend systems. With expertise in
          ...
          >
            ...
            <div>
              ...
              >
                {techStack.map((tech, index) => (
                  <motion.div
                    key={index}
                    className={`p-6 rounded-2xl text-center transform-gpu ${
                      isDarkMode
                        ? "bg-black/40 backdrop-blur-xl border border-white/10"
                        : "bg-white/80 backdrop-blur-xl border border-gray-200/50"
                    } shadow-xl`}
                  ...
                  >
                    <div
                      className={`p-4 rounded-2xl ${tech.bg} mb-4 mx-auto w-fit`}
                    >
                      <tech.icon className={`w-8 h-8 ${tech.color}`} />
                    </div>
                    <h4 className={`font-semibold mb-2 ${tech.color}`}>
                      {tech.name}
                    </h4>
                    <span
            ...
            <motion.div
              className={`p-8 rounded-3xl ${
                isDarkMode
                  ? "bg-gradient-to-br from-blue-900/20 to-purple-900/20 backdrop-blur-xl border border-white/10"
                  : "bg-gradient-to-br from-blue-50 to-purple-50 backdrop-blur-xl border border-gray-200/50"
              } shadow-2xl`}
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            <motion.div
              className={`p-6 rounded-2xl ${
                isDarkMode
                  ? "bg-gradient-to-r from-green-900/20 to-emerald-900/20 backdrop-blur-xl border border-green-500/20"
                  : "bg-gradient-to-r from-green-50 to-emerald-50 backdrop-blur-xl border border-green-200"
              } shadow-xl`}
              variants={float}
              animate="animate"
